...
node . init --name "React" --repo "facebook/react" --type github --hashtags react,reactjs
node . init --name "Ember.js" --repo "emberjs/ember.js" --type github --hashtags ember,emberjs
